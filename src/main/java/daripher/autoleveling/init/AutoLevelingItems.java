...
public class AutoLevelingItems {
  public static final DeferredRegister<Item> REGISTRY =
      DeferredRegister.create(ForgeRegistries.ITEMS, AutoLevelingMod.MOD_ID);

  public static final RegistryObject<Item> BLACKLIST_TOOL =
      REGISTRY.register("blacklist_tool", BlacklistToolItem::new);
  public static final RegistryObject<Item> WHITELIST_TOOL =
