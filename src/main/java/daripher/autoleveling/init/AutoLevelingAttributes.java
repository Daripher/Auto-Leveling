...
public class AutoLevelingAttributes {
	...
	public static final RegistryObject<Attribute> PROJECTILE_DAMAGE_BONUS = rangedAttribute("monster", "projectile_damage_bonus", 0, 0, 1000);
	public static final RegistryObject<Attribute> EXPLOSION_DAMAGE_BONUS = rangedAttribute("monster", "explosion_damage_bonus", 0, 0, 1000);
